        ...
        //if (newPostCount > 0) {
            ...
            <div class="row">
                <div class="col-sm-12" style="text-align:center">
                    <a href="/User/Timeline" style="color:#68849b;text-decoration:none;font-size:medium;font-weight:bold">Show ${newPostCount} new post</a>
                </div>
            </div>
        
        </div>`;
            if ($('.main-content-scoll').has('.new-post-count').length > 0) {
                $('.new-post-count').remove();
            }
        //print(newPostCount);
        $('.main-content-scoll').prepend(htmlElem);
        EnableScrollToTop();
...
$('.new-post-up-btn').click(() => {
    $('.main-content-scoll').animate({ scrollTop: 0 }, '50');
})
const EnableScrollToTop = () => {
    $('.main-content-scoll').scroll((e) => {
