            ...
            <div class="col-sm-12" style="border:1px solid red;border-radius:10px">
                <div class="row post-heading">
                    <div class="col-sm-2   flex-row-style">
                        ...
                        ${
                        s.obj.PROFILE_IMG !== null ? `<img src="/Admin/GetImage?name=${s.obj.AUTHOR}" class="img-circle" width="40px" height="40px" style="margin-right:10%;" />` :
                ...
                ${s.obj.TIMELINE_IMAGE !== null ? `<div class="row post-body">
                        <div class="col-sm-12">
                            <img  src="/Admin/GetPostImage?id=${s.obj.POST_ID}" alt="Post image" class="img-responsive" />
                        </div>
                    </div>` : ''}
